...
const commonErrors = {
    ...
    ServiceUnavailable: { name: 'ServiceUnavailable', httpStatus: 503 },
};
...
module.exports = {
    ...
    ServiceUnavailableError: (message, name = null, innerException = null) => new AppError(message, commonErrors.ServiceUnavailable.httpStatus, name || commonErrors.ServiceUnavailable.name, innerException),
};
